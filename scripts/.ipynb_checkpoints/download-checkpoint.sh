...
mkdir data/theoviel
unzip rsna-abdominal-trauma-detection-png-pt1.zip -d data/theoviel
# unzip rsna-abdominal-trauma-detection-png-pt2.zip -d data/theoviel
# unzip rsna-2023-abdominal-trauma-detection-pngs-3-8 -d data/theoviel
# unzip rsna-abdominal-trauma-detection-png-pt4.zip -d data/theoviel
# unzip rsna-abdominal-trauma-detection-png-pt5.zip -d data/theoviel
# unzip rsna-abdominal-trauma-detection-png-pt6.zip -d data/theoviel
# unzip rsna-abdominal-trauma-detection-png-pt7.zip -d data/theoviel
# unzip rsna-2023-abdominal-trauma-detection-pngs-18 -d data/theoviel
